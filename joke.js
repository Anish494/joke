...
`What did the three-legged dog saywhen he walked into a saloon\?
“I’m looking for the manwho shot my paw,`,

`How do you tell the difference beween a bull and a cow\?
It is either one or the udder`,

`What’s red and smells like blue paint\?
Red paint`,

`What’s the difference beween a hippo and a Zippo\?
One is very heavy, the other is  little lighter`,


`What happenedwhen Bluebeard fell overboard in the Red Sea\?
He got marooned`,
...
do{
  ...
  a=Math.floor(a);
tell(a);
ans=confirm("Do you want to hear another joke?");
}while(ans);
